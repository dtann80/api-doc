# weather OpenAPI Specification
[![Build Status](https://travis-ci.org/dtann80/api-doc.svg?branch=master)](https://travis-ci.org/dtann80/api-doc)
...
6. If you did everything correct, https://dtann80.github.io/api-doc/ will lead to your new docs
...
- Documentation(ReDoc): https://dtann80.github.io/api-doc/
- SwaggerUI: https://dtann80.github.io/api-doc/swagger-ui/
- Look full spec:
    + JSON https://dtann80.github.io/api-doc/swagger.json
    + YAML https://dtann80.github.io/api-doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://dtann80.github.io/api-doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dtann80.github.io/api-doc/ with url from the message: `Server started <url>`
